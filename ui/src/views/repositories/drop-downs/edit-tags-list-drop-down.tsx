...
import { DotsHorizontalIcon, PlusIcon, SearchIcon, XIcon } from "@mergestat/icons";

type RepositoryTagListProps = {
    tags: Array<{ title: string; checked: boolean }>
    setTags?:()=>void
  }
export const EditTagsListDropDown: React.FC<RepositoryTagListProps> = (props) => {
    const { tags } = props
    ...
    return (
      <Dropdown
              ...
              trigger={<DotsHorizontalIcon className=' w-4 h-4 mt-2' />}
            />
