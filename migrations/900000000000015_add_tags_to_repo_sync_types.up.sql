...
VALUES ('git', '#f34f29'), ('github', '#333333'), ('trivy', '#00ffe4'), ('syft', '#f67089')
...
('github', 'GITHUB_REPO_STARS'), ('github', 'GITHUB_PR_REVIEWS'), ('github', 'GITHUB_PR_COMMITS'), ('github', 'GITHUB_ACTIONS')
ON CONFLICT DO NOTHING;

INSERT INTO mergestat.repo_sync_type_tagged (name, typename)
VALUES ('trivy', 'TRIVY_REPO_SCAN'), ('syft', 'SYFT_REPO_SCAN')
ON CONFLICT DO NOTHING;
